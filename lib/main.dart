...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'PokeWoke',
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Color(0xFF0fdb00)),
        useMaterial3: true,
      ),
...
class _WebViewScreenState extends State<WebViewScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('PokeWoke'),
        backgroundColor: Color(0xFF0fdb00),
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: isUser ? Color(0xFF0fdb00) : Colors.grey[200],
